...
const char* scriptURL = "https://script.google.com/macros/s/AKfycbxJqB3kqn8MRBNbBCDFvmSqqBCqxBBuJPeWDvLEfh6rRCa0mIYv6NrRi-SD4b77jeZT/exec";  // your full URL
...
#define UART_TX 17  // To deterrent
#define UART_RX 16  // From deterrent
...
void writeScreen(const char* currentTime) {
  ...
  u8g2.drawStr(0, 20, String("Unit: ") + unitNumber);
